...
builder-action-add_script = Skript-Knoten hinzufügen
builder-script_inspector-title = Skript-Knoten
builder-script_inspector-unbound = Noch kein Skript gebunden – Platzhalter aktiv.
...
## Referenz-Picker (U1)
picker.no_results          = Keine Treffer
picker.loading             = Wird geladen…
picker.search.placeholder  = Suchen…
picker.selected_label      = Auswahl
