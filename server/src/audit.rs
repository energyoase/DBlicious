...
pub enum AuditKind {
    ...
    ApprovalDecision,
    /// Phase 1.7.10: Email-Versand (erfolgreich oder fehlgeschlagen).
    EmailEvent,
}
...
impl AuditKind {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            // EmailEvent: das tatsaechliche kind kommt vom Aufrufer
            // (email_sent | email_failed) — siehe record_email_event.
            AuditKind::EmailEvent => "email_event",
        }
    }
}
...
/// Phase 1.7.10: Email-Versand-Audit. `kind_str` ist `"email_sent"`
/// oder `"email_failed"` — wir gehen direkt ueber [`record`] und
